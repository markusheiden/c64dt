...
public enum Opcode {
  ...
  OPCODE_A4(0xA4, REG, LDY, ZP, 3),
  OPCODE_A5(0xA5, REG, LDA, ZP, 3),
  OPCODE_A6(0xA6, REG, LDX, ZP, 3),
  OPCODE_A7(0xA7, ILL, LAX, ZP, 3),
  ...
  OPCODE_C4(0xC4, REG, CPY, ZP, 3),
  OPCODE_C5(0xC5, REG, CMP, ZP, 3),
  OPCODE_C6(0xC6, REG, DEC, ZP, 5),
  OPCODE_C7(0xC7, ILL, DCP, ZP, 5),
  ...
  OPCODE_E4(0xE4, REG, CPX, ZP, 3),
  OPCODE_E5(0xE5, REG, SBC, ZP, 3),
  OPCODE_E6(0xE6, REG, INC, ZP, 5),
  OPCODE_E7(0xE7, ILL, ISC, ZP, 5),
